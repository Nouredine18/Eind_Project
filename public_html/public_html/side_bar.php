        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="home.php" class="logo">
              <img
                src="assets/img/kaiadmin/favicon.ico"
                alt="navbar brand"
                class="navbar-brand"
                height="25"
                width="25"
              />
              <div class="EcoLogo">Ecoligo_CO 
                <style>
                .EcoLogo {
                    color: white;
                    font-family: 'Bebas Neue', 'Agdasima', sans-serif; /* Gebruik nu beide fonts */
                }
                </style>
              </div>
            </a>
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <?php
                  ...
                  if ($userId > 0) {
                      ...
                      $sql = "SELECT notification_id, message, notification_type, created_at 
                              FROM notifications 
                              WHERE user_id = ? 
                      ...
                      $newNotifCount = count($notifications);
...
<li class="nav-item topbar-icon dropdown hidden-caret">
  ...
  >
    ...
    <span class="notification" id="notification-count"><?php echo $newNotifCount; ?></span>
  </a>
  <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
    <li>
      <div class="dropdown-title">
        You have <span id="new-notification-count"><?php echo $newNotifCount; ?></span> new notifications
      </div>
    </li>
    <li>
    ...
    <li>
      <a class="see-all" href="all_notifications.php">See all notifications
...
<?php
// Utility function to get the icon class based on notification type
...
// Utility function to get the color class based on notification type
...
?>
                    ...
                    <div class="quick-actions-scroll scrollbar-outer">
                      <div class="quick-actions-items">
                        <div class="row m-0">
                          ...
                          $quick_actions_sidebar = [ // Use a different variable name if $quick_actions is used elsewhere in this file
                              ...
                              ['icon' => 'fas fa-envelope', 'text' => 'Emails', 'link' => '#', 'bg_color' => 'bg-success'],
                          ];

                          foreach ($quick_actions_sidebar as $action): ?>
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  <?php
                    $sql = "SELECT first_name, last_name, birthdate, address, profile_picture_url FROM users WHERE email = ?";
                    $stmt = $conn->prepare($sql);
                    $stmt->bind_param("s", $_SESSION['email']);
                    $stmt->execute();
                    $stmt->bind_result($first_name, $last_name, $birthdate, $address, $profile_picture_url);
                    $stmt->fetch();
                    $stmt->close();
                  ?>
                  <a
